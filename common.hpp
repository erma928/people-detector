//
// Created by Feng Jimin on 3/6/19.
//

#ifndef LIFTDOOR_COMMON_H
#define LIFTDOOR_COMMON_H
...
void callback(int pos, void* userData)
{
    detect::DnnPeopleDetector* detector = (detect::DnnPeopleDetector*) userData;
    detector->setConfThreshold(pos * 0.01f);

}

#endif //LIFTDOOR_COMMON_H
